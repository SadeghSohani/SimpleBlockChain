...
class BlockChain() :
    ...
    def resolve_conflicts(self):
        '''check all nodes and select the best chain'''
...
def new_trx() :
    ...
    print(values)
    this_block = blockchain.new_trx(values['sender'],
        values['recipient'],
        values['amount']
    )
...
def consensus() :
    recplaced = blockchain.resolve_conflicts()
    if recplaced :
        response = {
            'message' : 'replaced!',
            'chain' : blockchain.chain
